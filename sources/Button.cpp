...
Button::Button(int width, int height, const std::string &text, const sf::Vector2f &position, const sf::Color &color) :
    width(width),
    height(height),
    text(text),
    position(position),
...
void Button::display(sf::RenderWindow& window){
    ...
    sf::Text text_(this->text, font_, this->height / 2);
...
bool Button::isHover(sf::Vector2f mousePos) {
