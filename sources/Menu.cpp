...
Menu::Menu(int menuType) : menuType (menuType){
    if (menuType == 1) {
        ...
        this->menu.push_back(Button{300, 50, "Select team", selectTeamButtonPosition, sf::Color::Black});
        sf::Vector2f backButtonPosition(1075, 750);
        this->menu.push_back(Button{300, 50, "Back to menu", backButtonPosition, sf::Color::Black});
    }
    else if (menuType == 3){
        sf::Vector2f advancePosition(80, 750);
        this->menu.push_back(Button{300, 50, "Advance", advancePosition, sf::Color::Black});
        sf::Vector2f viewPlayersPosition(460, 750);
        this->menu.push_back(Button{300, 50, "View players", viewPlayersPosition, sf::Color::Black});
        sf::Vector2f exitPosition(840, 750);
        this->menu.push_back(Button{300, 50, "Absolut nimic", exitPosition, sf::Color::Black});
